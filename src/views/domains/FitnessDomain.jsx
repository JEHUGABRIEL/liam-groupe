...
export default function FitnessDomain({ domain, events }) {
  ...
  const p = useLangPath();
  const gfitnessProducts = staticProducts;
  ...
  return (
    <div className="font-body bg-white">
      ...
      <section className="py-16 px-6 bg-white" ref={programsRef}>
      ...
      {gfitnessProducts.length > 0 && (
        <section className="py-16 px-6 bg-white" ref={productsRef}>
          <div className="max-w-6xl mx-auto">
            <div className="mb-14 text-center reveal">
              ...
              <h2 className="font-body font-bold uppercase text-4xl text-ink mt-3 tracking-tight">
                La boutique G-Fitness
              </h2>
              <p className="text-gray-500 text-sm mt-3 max-w-lg mx-auto">
                Sacs, accessoires et goodies aux couleurs de G-Fitness
              </p>
            </div>
            <div className="grid gap-7 stagger-children max-w-4xl mx-auto grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              {gfitnessProducts.map((product) => (
      ...
      {domain.pricing && (
        <section className="py-16 px-6 bg-gray-50" ref={pricingRef}>
          <div className="max-w-6xl mx-auto">
            <div className="mb-14 text-center reveal">
      ...
      <section className="py-16 px-8 bg-white" ref={weekRef}>
        <div className="max-w-6xl mx-auto">
      ...
      <section className="py-16 px-6 bg-gray-50" ref={galleryRef}>
        <div className="max-w-6xl mx-auto">
          <div className="mb-14 text-center reveal">
