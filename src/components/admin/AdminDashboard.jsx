...
import { LayoutGrid, CalendarDays, Newspaper, Users, Handshake, MessageSquareQuote, Mail, ArrowUpRight, ShoppingBag, ClipboardList } from "lucide-react";
...
export default function AdminDashboard({ onNavigate }) {
  ...
  const statCards = [
    ...
    {
      labelKey: "admin.sidebar.menu_items",
      label: t("admin.sidebar.menu_items"),
  ...
  const sectionNames = [t("admin.sidebar.domains"), t("admin.sidebar.events"), t("admin.sidebar.news"), t("admin.sidebar.team"), t("admin.sidebar.partners"), t("admin.sidebar.testimonials"), t("admin.sidebar.products"), t("admin.sidebar.menu_items"), t("admin.sidebar.messages"), t("admin.sidebar.registrations")];
  const slugs = ["domains", "events", "news", "team", "partners", "testimonials", "products", "menu_items", "messages", "registrations"];
